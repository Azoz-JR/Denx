...
@interface DetailSleepDayCell ()
/// 背景
@property (nonatomic, strong) UIView *bgView;

@end

@implementation DetailSleepDayCell
...
- (void)setModels:(NSArray *)models {
    ...
    if (!self.bgView) {
        ...
        for (int i = 0; i < models.count; i++) {
            ...
            UIView *itemView = [self.bgView viewWithTag:100+i];
            UIView *lineView = [self.bgView viewWithTag:2000+i];
            if (subTitleLabel) {
                subTitleLabel.text = cellModel.subTitle;
                lastView = itemView;
                lastLine = lineView;
                lineView.hidden = i == models.count-1;
            } else {
